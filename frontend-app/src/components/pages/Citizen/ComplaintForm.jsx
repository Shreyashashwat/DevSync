    ...
    <div className="min-h-screen overflow-y-auto flex justify-center items-start p-4 font-poppins bg-gray-100">
      <div className="bg-white rounded-xl p-8 shadow-2xl w-full max-w-md max-h-screen overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            {isGettingLocation && (
              <p className="text-blue-600 text-sm mb-2">Getting your location...</p>
            )}
            ...
            {!formData.latitude && !isGettingLocation && !locationError && (
              <p className="text-orange-600 text-sm mb-2">
                ⚠ Location is required to submit a complaint. Click the button below to allow location access.
              </p>
            )}
          </div>
